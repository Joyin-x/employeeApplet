...
Page({
    ...
    addTask: function(e) {
        let id = e.currentTarget.dataset.id,
			...
			console.log(this.data.userInfo.department_id);
		if (this.data.userInfo.flag == 1 && departmentId != this.data.userInfo.department_id){
			wx.showModal({
				title: '警告',
				content: this.data.userInfo.name + ',你的部门为' + this.data.userInfo.department_name+ ',只能为本部门的员工指派任务',
				showCancel: false,
				confirmText: "返回",
				confirmColor: "#00BFFF",
			});
